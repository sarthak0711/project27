...
function setup() {
    ...
    rope=new Rope(bob.body,roof.body,0,00);
    rope1=new Rope(bob3.body,roof.body,-50,00);
    rope2=new Rope(bob2.body,roof.body,100,00);
    rope3=new Rope(bob4.body,roof.body,-100,00);
    rope4=new Rope(bob1.body,roof.body,50,00);
